	...
	return (
		<Wrapper>
			<MainWrapper>
				...
				<ImgWrapper>
					<StyledImage src="/img/landing.png" alt="랜딩 이미지" fill priority placeholder="blur" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" />
				</ImgWrapper>
